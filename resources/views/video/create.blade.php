        ...
        <div class = 'container'>
            ...
            <form method = 'POST' action = '{{url("video")}}'>
                ...
                <div class="form-group">
                    ...
                    <input id="video_description" name = "video_description" type="text" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="video_category">video_category</label>
                    <input id="video_category" name = "video_category" type="text" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="video_type">video_type</label>
                    <input id="video_type" name = "video_type" type="text" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="video_upload_date">video_upload_date</label>
                    <input id="video_upload_date" name = "video_upload_date" type="text" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="video_total_views">video_total_views</label>
                    <input id="video_total_views" name = "video_total_views" type="text" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="video_upload_user_id">video_upload_user_id</label>
                    <input id="video_upload_user_id" name = "video_upload_user_id" type="text" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="video_delete_date">video_delete_date</label>
                    <input id="video_delete_date" name = "video_delete_date" type="text" class="form-control">
                </div>
